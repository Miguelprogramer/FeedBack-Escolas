...
//A função inicio é usada somente ao iniciar o programa, serve apenas para informar o funcionamento do programa
	funcao inicio()
	{
		escreva("*********************************************************************************\n")
...
//A função opcoes tem a funcionabilidade de passar para outra funções por meio de escolha
	funcao opcoes()
	{
		limpa()
...
//Essa função informa quantos comentários estão disponiveis, se ainda haver espaço para comentarios chama uma outra função	
...
//Essa função é chamada quando não há mais comentários disponiveis	
...
//Escreve os comentários no console do portugol	
...
//Escreve os comentários em uma janela
	funcao imprimir()
	{
		chave=""
		limite_comentario=1
...
//Escreve o autor de cada comentário	
	funcao usuario()
	{
		se(maximo_comentario!=0)
		{
